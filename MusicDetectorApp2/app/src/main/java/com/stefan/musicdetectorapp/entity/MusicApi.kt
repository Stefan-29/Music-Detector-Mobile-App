...
interface MusicApi {
    ...
    @GET("search")
     fun getCurrentSongRecommendations(@Query("term") term: String?, @Query("locale") region: String?) : Call<SearchResult?>?
    //suspend fun identifySong(@Body audioSample: AudioSample): Response<SongMetadata>
}